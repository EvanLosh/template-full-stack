        ...
        <div id="home">
            ...
            <div className="collapseable ">
                <div className="collapseable-headline">
                    ...
                    <button className="collapse-button" onClick={() => setFeaturesCollapsed(!featuresCollapsed)}>{buttonContent(featuresCollapsed)}</button>
                    <h3>The features of this project</h3>
                </div>
            ...
            <div className="collapseable ">
                <div className="collapseable-headline">
                    <button className="collapse-button" onClick={() => setGuideCollapsed(!guideCollapsed)}>{buttonContent(guideCollapsed)}</button>
                    <h3>Get started</h3>
                </div>
                <ol className={guideCollapsed ? "collapse" : ""}>
                    ...
                    {/* <li>Finally, the project can be built by running: </li>
                    <div className="code-block">
                        <p>client$ npm run build</p>
                    </div> 
                        */}
                </ol>
